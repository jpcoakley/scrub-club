...
- Team letters: `CAPTAINS` (C: David Sanders) and `ALTERNATES` (A: Adam Davis, Fred Small) near the top of index.html's CONFIG. Names must match the roster sheet's First + Last exactly.
